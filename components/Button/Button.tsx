...
export const Button = styled.button<Props>`
  ...
  box-shadow: ${({ theme }) =>
    `0.5vmin 0.5vmin 1vmin ${theme.components.shadow1}, -0.5vmin -0.5vmin 1vmin ${theme.components.shadow1}`};

  &:active {
    box-shadow: ${({ theme }) =>
      `0.5vmin 0.5vmin 1vmin ${theme.components.shadow1} inset, -0.5vmin -0.5vmin 1vmin ${theme.components.shadow1} inset`};
  }
`;
